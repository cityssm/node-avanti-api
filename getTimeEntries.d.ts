...
export declare function getTimeEntries(viewId: string, templateId: string, parameters: GetTimeEntries_Request, credentials: ApiRequestCredentials): Promise<GetTimeEntries_TimeEntry[]>;
