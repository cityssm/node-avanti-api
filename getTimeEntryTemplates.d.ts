...
export declare function getTimeEntryTemplates(parameters: GetTimeEntryTemplates_Request, credentials: ApiRequestCredentials): Promise<GetTimeEntryTemplates_TimeEntryTemplate[]>;
